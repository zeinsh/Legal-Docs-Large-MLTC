...
pretrained_model_name=$projectDir"/training/LM-finetuning/lm-finetuned/jrc_3langs/distilbert10EPOCH_LMFT"
...
experiment_name="adv-10LMFT-ZSL-DE"

trainLanguages="en,fr"
testLanguages="de"
...
then
    ...
    python finetune.py --LABEL_COL_NAME=$LABEL_COL_NAME \
                        ...
                        --cased=$cased \
                        --use_language_adversarial_training=1 \
